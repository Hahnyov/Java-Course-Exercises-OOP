package Exercises.Ex2_Encapsulation.ClassBoxDataValidation.PizzaCalories;
...
public class Dough {
    ...
    private void setWeight(double weight) {
        //•	If dough weight outside of the range [1..200] throw an exception with the message
